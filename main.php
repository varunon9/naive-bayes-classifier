<?php
    ...
    $classifier -> train('Have a pleasurable stay! Get up to 30% off + Flat 20% Cashback on Oyo Room bookings done via Paytm', $spam);
    /*$classifier.train('Lets Talk Fashion! Get flat 40% Cashback on Backpacks, Watches, Perfumes, Sunglasses & more', $spam);
    $classifier.train('One Stop Solution for all Electronic Needs! Get up to 64% off on Home Appliances, Mobiles & more', $spam);
